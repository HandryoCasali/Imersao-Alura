...
function jogar() {
    ...
    if (cartas.length == 0){
      ...
      if(pontosJogador > pontosMaquina){
        htmlResultado = '<p class="resultado-final">GANHOU contra a máquina</p>'
      } else if (pontosJogador < pontosMaquina){
        htmlResultado = '<p class="resultado-final">PERDEU contra a máquina</p>'
      } else {
        htmlResultado = '<p class="resultado-final">EMPATOU contra a máquina</p>'
      }
    } else {
